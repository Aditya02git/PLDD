      ...
      <div className="container mx-auto px-4">
        ...
        <div className="md:grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-400 text-sm">
              Empowering farmers with knowledge to protect crops and livestock,
          ...
          <div className="mb-6">
            ...
            <ul className="text-gray-400 text-sm space-y-2">
              ...
              <li>
                <Link to="/diseasedetection" className="hover:text-black">
                  Disease Detection
                </Link>
              </li>
              <li>
        ...
        <div className="my-8 grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end gap-4">
            <a
              href="#"
              className="text-gray-400 hover:text-black flex items-center space-x-2"
            >
        ...
        <div className="text-center text-gray-400 text-sm mt-6">
          <p>© 5MinCare.Ai All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
