...
const DiseaseForm = () => {
  ...
  return (
    ...
    >
      <h2 className="text-[30px] mt-20 md:text-4xl text-black dark:text-white font-bold">
      ...
      <form onSubmit={handleImageSubmit}>
        ...
        <button
          className="bg-green-700 mb-10 hover:bg-green-800 p-4 rounded-md font-bold text-2xl text-center text-black dark:text-white "
          type="submit"
        >
