...
const Signup = () => {
  ...
  return (
    <div className="h-screen bg-white bg-cover md:bg-center bg-[right] bg-fixed top-0 left-0 w-full z-0 dark:bg-slate-900 dark:bg-cover md:dark:bg-[center_top] dark:bg-[right] dark:bg-fixed">
            ...
            <form onSubmit={handleSignup}>
              <div className="md:flex text-center space-x-2 items-center justify-center mb-3 ml-9 space-y-4 md:ml-0 md:space-y-0">
                <input
                  ...
                  className="input input-bordered md:w-5/12 w-10/12 bg-white text-black"
                  required
                />
                <input
                  type="text"
              ...
              <div className="flex flex-col items-center justify-center space-y-5">
                <input
                  ...
                  onChange={handleChange}
                  className="input input-bordered md:w-10/12 w-9/12 bg-white text-black"
                  required
                />
                <input
                  type="password"
              ...
              <div className="card-actions justify-center mt-5">
                <button
                  type="submit"
                  className="bg-black dark:bg-white text-white dark:text-black px-3 py-2 rounded-md dark:hover:bg-gray-300 hover:bg-slate-800 duration-300 cursor-pointer border-2 border-slate-600"
                >
                  Sign Up
                </button>
              </div>
